                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check-inline form-check">
                                                <label for="inline-radio1" class="form-check-label ">
                                                    <input type="radio" id="inline-radio1" name="radio_status" value=0 {{$data->status_kategori==0?'checked':''}} class="form-check-input">Berlangsung
                                                </label>
                                                <label for="inline-radio2" class="form-check-label ">
                                                    <input type="radio" id="inline-radio2" name="radio_status" value=1 {{$data->status_kategori==1?'checked':''}}  class="form-check-input">Selesai
                                                </label>
                                            </div>
                                        </div>
                                    </div>
