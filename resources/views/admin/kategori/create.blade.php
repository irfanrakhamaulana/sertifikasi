                            ...
                            <form action="{{route('kategori.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                               @csrf
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="txt_namakategori" placeholder="Text" class="form-control"><small class="form-text text-muted">Isikan dengan nama kategori</small></div>
                                </div>
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check-inline form-check">
                                                <label for="inline-radio1" class="form-check-label ">
                                                    <input type="radio" id="inline-radio1" name="radio_status" value=0 class="form-check-input">Berlangsung
                                                </label>
                                                <label for="inline-radio2" class="form-check-label ">
                                                    <input type="radio" id="inline-radio2" name="radio_status" value=1 class="form-check-input">Selesai
                                                </label>
                                            </div>
                                        </div>
                                    </div>
